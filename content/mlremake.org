...
{{<practice>}}
{{<link url="https://westgrid-ml.netlify.app/school/pt-06-code.html" text="How to code a neural network?">}}<br>
{{</practice>}}
...
{{<video>}}
{{<link url="https://westgrid-ml.netlify.app/school/pt-10-calculus.html" text="Calculus of backpropagation">}}<br>
{{</video>}}

{{<practice>}}
{{<link url="https://westgrid-ml.netlify.app/school/pt-11-gradient.html" text="Our turn to dive into backpropagation">}}<br>
{{</practice>}}
