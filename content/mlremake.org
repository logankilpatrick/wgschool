...
In this session, I will go over the program for this course, explain what you will have to do before our next live session, and we will introduce each other.
{{</zt>}}
...
{{<annex>}}
{{<link url="https://westgrid-ml.netlify.app/schoolremake/pt-03-local.html" text="Optional: installing PyTorch locally">}}<br>
{{</annex>}}
