...
/(New version of the course—still under development)/
...
{{<reading>}}
{{<link url="https://westgrid-ml.netlify.app/schoolremake/pt-02-concepts.html" text="Concepts">}}<br>
{{</reading>}}

{{<practice>}}
{{<link url="https://westgrid-ml.netlify.app/schoolremake/pt-03-install.html" text="Installing PyTorch and logging in a training cluster">}}<br>
{{</practice>}}

{{<dt "2–3:30pm">}}
{{<link url="https://westgrid-ml.netlify.app/schoolremake/pt-04-debug.html" text="Issues installing PyTorch locally or logging in the training cluster">}}<br>
This session is not part of the actual course. Please only sign up for it if you have followed the instructions on <a href="https://westgrid-ml.netlify.app/schoolremake/pt-03-install.html">installing PyTorch and logging in the training cluster</a> but are having issues.
{{</dt>}}
...
{{<practice>}}
{{<link url="https://westgrid-ml.netlify.app/schoolremake/pt-06-tensor.html" text="Tensors">}}<br>
{{</practice>}}
