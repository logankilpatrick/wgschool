...
{{<practice>}}
{{<link url="https://westgrid-ml.netlify.app/schoolremake/pt-12-autograd.html" text="Automatic differentiation">}}<br>
{{</practice>}}

{{<video>}}
{{<link url="https://westgrid-ml.netlify.app/schoolremake/pt-13-calculus.html" text="A bit of calculus">}}<br>
{{</video>}}
