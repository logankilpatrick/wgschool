...
{{<practice>}}
{{<link url="https://westgrid-ml.netlify.app/school/pt-04-install.html" text="Installing PyTorch and logging to the training cluster">}}<br>
{{</practice>}}

{{<reading>}}
{{<link url="https://westgrid-ml.netlify.app/school/pt-05-hpc.html" text="Running ML jobs on Compute Canada clusters">}}<br>
{{</reading>}}
...
This session is not part of the actual course. Please only sign up for it if you have followed the instructions on <a href="https://westgrid-ml.netlify.app/school/pt-04-install.html">installing PyTorch and logging to the training cluster</a> but are having issues.
{{</dt>}}
