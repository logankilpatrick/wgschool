...
This session is not part of the actual course. Please only sign up for it if you have carefully followed the session on <a href="https://westgrid-ml.netlify.app/school/pt-03-install.html">installing Python and PyTorch</a>, but are still having technical difficulties.
{{</dt>}}
