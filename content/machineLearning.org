...
*June 8*
{{<zt "9–9:30am">}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-01-intro.html" text="Introduction to the WestGrid Summer School PyTorch course">}}<br>
I will go over the program for this course and we will introduce each other.
{{</zt>}}

{{<reading>}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-02-concepts.html" text="Concepts">}}<br>
{{</reading>}}

{{<video>}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-03-nn.html" text="What are neural networks?">}}<br>
{{</video>}}

{{<practice>}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-04-install.html" text="Installing PyTorch and logging in the training cluster">}}<br>
{{</practice>}}

{{<dt "2–3:30pm">}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-05-debug.html" text="Issues installing PyTorch locally or logging in the training cluster">}}<br>
This session is not part of the actual course. Please only sign up for it if you have followed the instructions on <a href="https://westgrid-ml.netlify.app/summerschool2020/pt-04-install.html">installing PyTorch and logging in the training cluster</a> but are having issues.
{{</dt>}}

{{<practice>}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-06-exposure.html" text="First exposure to PyTorch">}}<br>
{{</practice>}}

*June 9*
{{<zt "9–10am">}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-07-basics.html" text="PyTorch basics">}}<br>
In this session, we will discuss <a href="https://westgrid-ml.netlify.app/summerschool2020/pt-06-exposure.html">the code you looked at yesterday</a> and move from there to some of the key features of PyTorch.
{{</zt>}}

{{<reading>}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-08-hpc.html" text="Running ML jobs in Compute Canada clusters">}}<br>
{{</reading>}}

{{<reading>}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-09-distributed.html" text="Distributed computing with PyTorch">}}<br>
{{</reading>}}

{{<zt "2–3:30pm">}}
{{<link url="https://westgrid-ml.netlify.app/summerschool2020/pt-10-mnist.html" text="MNIST classification">}}<br>
In this session, we will apply the functions we learnt in <a href="https://westgrid-ml.netlify.app/summerschool2020/pt-07-basics.html">PyTorch basics</a> to a real example. As we train our model, we will track its performance with TensorBoard.
{{</zt>}}
